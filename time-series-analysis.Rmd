...
# load & look at data 
daily_data = read.csv('/cloud/project/Data/day.csv', header=TRUE, stringsAsFactors=FALSE)
```
...
Fitting an ARIMA(p,d,q) model requires the series to be stationary. A series is said to be stationary when its mean, variance, and autocovariance are time invariant. Since ARIMA uses previous lags of series to model its behavior, modeling stable series with consistent properties involves less uncertainty.
